"""Generated by atdpy from type definitions in def_.atd.

This implements classes for the types defined in 'def_.atd', providing
...
class Priority:
    ...
    @classmethod
    def from_json(cls, x: Any) -> 'Priority':
    ...
    @classmethod
    def from_json_string(cls, x: str) -> 'Priority':
        return cls.from_json(json.loads(x))
