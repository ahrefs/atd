/*
  Generated by atdts from type definitions in 'ext_types.atd'.
...
export type Priority = number /*int*/
...
export function writePriority(x: Priority, context: any = x): any {
  return _atd_write_int(x, context);
}

export function readPriority(x: any, context: any = x): Priority {
