/*
  Generated by atdts from type definitions in 'import_alias.atd'.
...
export function writeItem(x: Item, context: any = x): any {
  return {
    'tag': _atd_write_required_field('Item', 'tag', etypes.writeTag, x.tag, x),
  };
}

export function readItem(x: any, context: any = x): Item {
  return {
    tag: _atd_read_required_field('Item', 'tag', etypes.readTag, x['tag'], x),
  };
}
